...
export type ItemsWithMetricsQuery = { __typename?: 'Query', items: Array<{ __typename: 'Item', id: string, item_type: string, tags?: Array<string> | null, label: string, configs: Array<{ __typename?: 'Config', start_epoch: number, summary: number, field: string, data: Array<string | null> }>, metrics: Array<{ __typename: 'Metric', start_epoch: number, summary: number, formula: string, data: Array<number | null>, function: string }> }> };

export type ConfigsFragment = { __typename?: 'Item', configs: Array<{ __typename?: 'Config', start_epoch: number, summary: number, field: string, data: Array<string | null> }> };

export type MetricsFragment = { __typename: 'Item', metrics: Array<{ __typename: 'Metric', start_epoch: number, summary: number, formula: string, data: Array<number | null>, function: string }> };
...
export type GetTypesQuery = { __typename?: 'Query', type_ahead: { __typename?: 'TypeAhead', types?: Array<string> | null } };
